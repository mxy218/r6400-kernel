...
#define GPIO_USB1_LED_R6700V3  13   /* USB1 LED. */
#elif (defined R6700)
...
static int usb1_normal_blink_smp(void)
{
    ...
    if (interrupt_count1 == 0){
        ...
        if(is6700v3)
            gpio_led_on_off(GPIO_USB1_LED_R6700V3, led_on);  /* foxconn add ken chen, 12/13/2013, to support LED control Settings */
        else        
...
//old0=usb1_pkt_cnt_old;
            ...
            if(is6700v3)
                gpio_led_on_off(GPIO_USB1_LED_R6700V3, led_off);  /* foxconn add ken chen, 12/13/2013, to support LED control Settings */
            else
...
#else
                if(is6700v3)
                    gpio_led_on_off(GPIO_USB1_LED_R6700V3, 1);
                else
                    gpio_led_on_off(GPIO_USB1_LED, 1);
#endif
